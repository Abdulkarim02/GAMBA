...
2. Check mode
    ...
    * Both:
        ...
        * If it isn't in the whitelist:  
          * Frontend extracts scripts and preprocesses $[2]$ them
3.  Frontend sends html to Backend to receive `html_response` $_[3]$
4.  Frontend sends scripts to Backend to receive `scripts_response` $_[4]$
5.  Frontend accepts feedback from the users $_[5]$
