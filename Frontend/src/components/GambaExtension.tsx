  ...
  return (
    <div className="w-[400px] h-[600px] overflow-hidden">
      ...
      >
        ...
        <div 
          className={`absolute top-0 right-0 h-full w-64 z-30 transition-transform duration-300 ${
            ...
            <div className="mb-6">
              ...
              <div className="relative">
                <select
                  ...
                  className={`w-full px-4 py-3 rounded-lg appearance-none cursor-pointer transition-all duration-200 font-medium ${
                    isDarkMode
        ...
        <div className="relative z-10 h-full flex flex-col p-5">
            ...
            >
              <Power 
                className={`w-5 h-5 transition-all duration-300 ${
                  isPoweredOn ? 'text-white' : isDarkMode ? 'text-slate-400' : 'text-gray-600'
                }`}
              />
            </button>
          ...
          {/* Data Cards */}
          <div className={`rounded-xl p-4 mb-5 border backdrop-blur-sm ${
            isDarkMode 
          ...
          <div className="mt-auto">
            ...
            <div className="flex gap-3">
              ...
              <button
                ...
                className={`w-32 h-12 rounded-lg flex items-center justify-center gap-2 font-semibold transition-all duration-300 ${
                  !isPoweredOn
                    ? isDarkMode
              ...
              <button
                ...
                disabled={!isPoweredOn}
                className={`flex-1 h-12 rounded-lg flex items-center justify-center gap-2 font-semibold transition-all duration-300 ${
                  !isPoweredOn
                    ? isDarkMode
                      ? 'bg-slate-800 text-slate-600 cursor-not-allowed'
                      : 'bg-gray-200 text-gray-400 cursor-not-allowed'
